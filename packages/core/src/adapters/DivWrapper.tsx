...
function mapPointerEvents(pointerEvents: RNPointerEvents | undefined): React.CSSProperties['pointerEvents'] {
  if (pointerEvents === 'none') return 'none';
  // RN's box-none/box-only aren't directly representable in CSS without extra wrappers.
  return 'auto';
}

export const DivWrapper: WrapperComponent = ({ children, style, pointerEvents }: WrapperProps) => {
